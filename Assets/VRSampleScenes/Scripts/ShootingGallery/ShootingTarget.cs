...
namespace VRStandardAssets.ShootingGallery
{
    ...
    {
        public event Action<ShootingTarget> OnRemove;                   // To zdarzenie jest uruchamiane wtedy, gdy cel musi być usunięty.


        [SerializeField] private int m_Score = 1;                       // This is the amount added to the users score when the target is hit.
        [SerializeField] private float m_TimeOutDuration = 2f;          // Jak długo trwa cel zanim zniknie.

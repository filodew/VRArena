...
{
    // Jest to skrypt tyczący prostych obiektów
    // który pozwala na przypadkową zmienność prefabrykatów.
    public class ObjectPool : MonoBehaviour
    {
        ...
        private List<GameObject> m_Pool = new List<GameObject> ();  // Lista instancji prefabrykatów tworzących pulę. | The list of instantiated prefabs making up the pool.

...
namespace VRStandardAssets.Utils
{
    ...
    public class VRInteractiveItem : MonoBehaviour
    {
        ...
        public event Action OnUp;               // Wywoływana, gdy Fire1 jest uwalniana podczas gdy wzrok jest na tym obiekcie.
        public event Action OnDown;             // Wywoływana, gdy zostanie naciśnięty Fire1 podczas gdy wzrok jest na tym obiekcie.

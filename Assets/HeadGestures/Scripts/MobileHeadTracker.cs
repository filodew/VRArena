...
// Very simple mobile tracker based on accelerometer/compass (which should work with older phones which have no gyroscope)
public class MobileHeadTracker : MonoBehaviour {
	...
	void Update () {
		...
		transform.eulerAngles =  new Vector3 (Input.acceleration.z * -90f * -1f, Input.compass.magneticHeading-initHeading, 0f) * -1f;
